...
<section id="how_to_help">
    <div class="container container-narrow">
        ...
        <div class="section-content"><?= Html::escape(l('Quest\'anno PoliMi Pride ha tanti gadget colorati in più! Le sacche/zainetto, gli adesivi e le spille completano il set di gadget targati "Polimi Pride" insieme alla maglietta!')) ?>
            <br/><?= l('Ma per realizzarli abbiamo bisogno del vostro sostegno: lo scorso anno il Politecnico aveva finanziato la realizzazione dei materiali, ma quest\'anno non è più stato possibile farlo, perciò abbiamo lanciato una <strong>campagna di crowdfunding</strong> per raccogliere i fondi per ordinare tutti i materiali PoliMi Pride.') ?>
        </div>
    </div>
</section>
    ...
    <div class="row justify-content-around no-gutters">
        <div class="col-10 col-md-5 col-lg-3 reward">
            <div class="reward-box">
                <img src="<?= Url::resource("assets/imgs/sacca.png"); ?>"
                     alt="<?= Html::escape(l('Sacca Zainetto PoliMi Pride')); ?>"/>
        ...
        <div class="col-10 col-md-5 col-lg-3 reward">
            <div class="reward-box">
                <img src="<?= Url::resource('assets/imgs/adesivi_spille.png') ?>"
                     alt="Spille, Adesivi e Shopper PoliMi Pride"/>
            ...
            <div class="reward-description">
                <?= Html::escape(l("Mostra il tuo orgoglio! Con gli adesivi e la spilla PoliMi Pride potrai esprimere ovunque il tuo supporto all'iniziativa. Usali per personalizzare i tuoi oggetti, dal pc al tuo zaino!")); ?>
                <br/><strong><em><?= Html::escape(l('(Sacca zainetto inclusa)')) ?></em></strong>
            </div>
        </div>
        <div class="col-10 col-md-6 col-lg-3 reward">
            ...
            <div class="reward-description">
                <?= Html::escape(l("Non perderti la maglietta PoliMi Pride! Con la sua immagine rinnovata è disponibile sia in formato t-shirt che come canotta, scegli quella che fa più per te!")); ?>
                <br/><strong><em><?= Html::escape(l('(Sacca, spilla e adesivi inclusi)')) ?></em></strong>
            </div>
        </div>
    </div>
</section>
